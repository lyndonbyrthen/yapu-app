...
import { getPinyinSyllabary, getPinyinYapu1to1 } from "@lib/analysis/PhoneticAnalysisUtils";
...
const outPathY = "scripts/data/yapinToPinyin.csv";
const outPathP = "scripts/data/pinyinToYapin.csv";

fs.writeFileSync(outPathY, yRow.join("\n"), "utf8");
fs.writeFileSync(outPathP, pRow.join("\n"), "utf8");
